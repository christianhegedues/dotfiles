...
local function lsp_keymaps(bufnr)
  ...
  keymap(bufnr, "n", "<leader>dd", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
  ...
  keymap(bufnr, "n", "<leader>dc", "<cmd>lua vim.lsp.buf.declaration()<CR>", opts)
  keymap(bufnr, "n", "<leader>df", "<cmd>lua vim.lsp.buf.definition()<CR>", opts)
  keymap(bufnr, "n", "<leader>dr", "<cmd>lua vim.lsp.buf.references()<CR>", opts)
  keymap(bufnr, "n", "<leader>di", "<cmd>lua vim.lsp.buf.implementation()<CR>", opts)
  keymap(bufnr, "n", "<leader>dk", "<cmd>lua vim.lsp.buf.hover()<CR>", opts)
